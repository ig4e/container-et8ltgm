...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-et8ltgm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-et8ltgm.containers.anotherwebservice.com/
...
```
git clone git@github.com:ig4e/container-et8ltgm.git
cd container-et8ltgm
```
...
```
docker attach container-et8ltgm
```
